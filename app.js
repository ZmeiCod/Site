...
document.getElementById('forms').addEventListener('submit', function(event) {
    ...
    if (spamProtectionValue === 'protected') {
      // если скрытое поле заполнено правильным значением, продолжаем выполнение
    } else {
      // если скрытое поле заполнено другим значением или пусто, это мог быть спам-бот
      event.preventDefault();
      alert('Spam protection activated! Please fill out the form correctly.');
    }
});

// добавим значение в скрытое поле при загрузке страницы
